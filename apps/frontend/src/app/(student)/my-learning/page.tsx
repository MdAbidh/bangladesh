...
const MOCK_ENROLLMENTS = Array.from({ length: 12 }).map((_, i) => ({
  ...
  course: {
    ...
    language: 'English', duration: 5 + (i * 2) % 20,
    totalLessons: 10 + (i * 3) % 50, totalSections: 3 + (i % 6),
    totalEnrollments: 100 + (i * 250) % 3000, averageRating: parseFloat((3.5 + (i % 5) * 0.3).toFixed(1)),
    totalReviews: 10 + (i * 25) % 300, price: [0, 49.99, 79.99][i % 3],
    discountedPrice: i === 2 ? 29.99 : null, isFree: i % 3 === 0, isPublished: true, isFeatured: false,
    status: 'PUBLISHED' as const,
    teacher: { id: `t${i}`, firebaseUid: '', email: '', firstName: 'John', lastName: 'Doe', displayName: 'John Doe', avatarUrl: null, role: 'TEACHER', phoneNumber: null, bio: null, isActive: true, isEmailVerified: true, lastLoginAt: null, createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
  ...
  progress: (i * 13) % 100,
  completedLessons: (i * 5) % 30,
  totalLessons: 10 + (i * 3) % 50,
  enrolledAt: '2024-01-01T00:00:00Z',
  completedAt: i % 3 === 1 ? '2024-06-15T00:00:00Z' : null,
  expiresAt: null,
