...
export class CreateCourseDto {
  @ApiProperty({ example: 'Complete Node.js Course', description: 'Course title' })
  @IsString()
  ...
  @ApiProperty({ enum: CourseLevel, default: CourseLevel.BEGINNER, description: 'Course difficulty level' })
  @IsOptional()
